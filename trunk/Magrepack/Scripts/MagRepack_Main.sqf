...
outlw_MR_createDialog =
{
	...
	((uiNamespace getVariable "outlw_MR_Dialog_Main") displayCtrl 1001) ctrlSetText (localize "STR_OUTLW_MR_MAGAZINE_REPACK");
	...
	((uiNamespace getVariable "outlw_MR_Dialog_Main") displayCtrl 22170) lbAdd localize "STR_OUTLW_MR_ALL_AMMO_TYPES";
...
outlw_MR_populateMagListBox =
{
	...
	//_magListTitle = "All Magazines";STR_OUTLW_MR_ALL_MAGAZINES
	_magListTitle = localize "STR_OUTLW_MR_ALL_MAGAZINES";
	if (outlw_MR_sourceType != "" || {outlw_MR_targetType != ""} || {outlw_MR_currentFilter != ""}) then
	{
		_args = (_args) call outlw_MR_filter;
		//_magListTitle = "Compatible Mags";STR_OUTLW_MR_COMPATIBLE_MAGS
		_magListTitle = localize "STR_OUTLW_MR_COMPATIBLE_MAGS";
	};

//P:\TacBF\outlw_magrepack\Configs\MagRepack_Dialog_Main.hpp
	...
	class Controls
	{
		...
		*/
		class MR_MainTitle: outlw_MR_RscStructuredText
		{
			...
			//text = "Magazine Repack";
			text = "$STR_OUTLW_MR_MAGAZINE_REPACK";
		...
		class MR_MagListTitle: outlw_MR_RscStructuredText
		{
			...
			//text = "All Magazines";
			text = "$STR_OUTLW_MR_ALL_MAGAZINES";
